...
(0, _jquery2.default)('#offCanvas').foundation('open');
...
if ((0, _jquery2.default)(window).width() >= 640) {
  ...
  var toggleWidth = function toggleWidth(offCanvasWidth, offCanvasContentWidth) {
    (0, _jquery2.default)('#offCanvas').animate({ width: offCanvasWidth }, 500);
    (0, _jquery2.default)('#offCanvasContent').animate({ width: offCanvasContentWidth }, 500);
  };

  var offCanvasOpacity = function offCanvasOpacity(op, duration) {
    (0, _jquery2.default)('#offCanvas').animate({ opacity: op }, duration);
    (0, _jquery2.default)('.tabs-panel').animate({ opacity: op }, duration);
  };

  var btnExpandText = function btnExpandText(expanded) {
    if (expanded) {
      (0, _jquery2.default)('#btnExpand').html('Weniger Ergebnisse <i class ="icon ion-android-remove icon--small"></i>');
    } else {
      (0, _jquery2.default)('#btnExpand').html('Mehr Ergebnisse <i class ="icon ion-android-add icon--small"></i>');
    }
  };
  ...
  (0, _jquery2.default)('#btnExpand').on('click', function () {
    ...
    if (!expanded) {
      ...
      (0, _jquery2.default)('#panel-results').addClass('is-collapsed');
    } else {
      toggleWidth('35rem', '30rem');
      expanded = false;
      (0, _jquery2.default)('#results-collapsed').removeClass('results-display-none');
      (0, _jquery2.default)('#results-wrap').addClass('results-display-none');
      (0, _jquery2.default)('#panel-results').removeClass('is-collapsed');
    }
  ...
  (0, _jquery2.default)('#btnCloseOffcanvas').on('click', function () {
    offCanvasOpacity(0, 500);
  });

  // makes sure all faded elements become visible when opening off-canvas
  (0, _jquery2.default)('#openOffCanvas').on('click', function () {
...
// for scenario panel
(0, _jquery2.default)('input:radio[name="scenario"]').change(function () {
