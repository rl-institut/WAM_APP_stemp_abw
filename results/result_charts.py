    ...
    return [
        {
            ...
            'setup_labels': {
                'title': {'text': str(
                    _('Zusammensetzung Stromerzeugung (Dein Szenario)'))},
                'subtitle': {'text': str(_('in GWh'))},
                'yAxis': {'title': {'text': str(_('GWh'))}}
            },
        ...
        },
        {
            ...
            'setup_labels': {
                'title': {'text': str(
                    _('Zusammensetzung Stromerzeugung (Status quo)'))},
                'subtitle': {'text': str(_('in GWh'))},
                'yAxis': {'title': {'text': str(_('GWh'))}}
            },
            'data': pd.DataFrame(data={'name': [str(_('Windenergie')),
        ...
        },
        {
            ...
            'setup_labels': {
                'title': {'text': str(
                    _('Monatliche Stromerzeugung aus EE (Dein Szenario)'))},
                'subtitle': {'text': str(_('in GWh'))},
                'yAxis': {'title': {'text': str(_('GWh'))}}
